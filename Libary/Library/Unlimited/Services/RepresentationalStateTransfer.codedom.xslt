                ...
                <objectCreateExpression type="Regex">
                  <parameters>
                    <primitiveExpression>
                      ...
                      <xsl:attribute name="value"><![CDATA[^(?'ScriptName'[\w\-]+?)(\-(?'Version'[\.\d]+))?(\.(?'Culture'[\w\-]+?))?\.(?'Extension'js|css)]]></xsl:attribute>
                    </primitiveExpression>
                    <propertyReferenceExpression name="IgnoreCase">
                      <typeReferenceExpression type="RegexOptions"/>
                    </propertyReferenceExpression>
                        ...
                        <assignStatement>
                          ...
                          <methodInvokeExpression methodName="Replace">
                            ...
                            <parameters>
                              ...
                              <primitiveExpression value=" sourceMappingURL=../scripts/"/>
                            </parameters>
                          </methodInvokeExpression>
                        </assignStatement>
                      ...
                      <trueStatements>
                        <methodInvokeExpression methodName="AppendFormat">
                          ...
                          <parameters>
                            ...
                            <stringFormatExpression format="$('&lt;link>&lt;/link>').appendTo($('head')).attr({{{{ href: '{{0}}/touch//jquery.mobile-{{1}}.min.css', type: 'text/css', rel: 'stylesheet' }}}});">
