...
Web.DataViewResources.Mobile = {
    ...
    List: '^ListOneColumn^List (One Column)^ListOneColumn^',
    Cards: '^List^List^List^',
    Grid: '^Grid^Grid^Grid^',
    Map: '^Map^Map^Map^',
    ...
    ClearText: '^ClearText^Clear Text^ClearText^',
    ...
    LabelsInForm: {
        ...
        List: {
            AlignedLeft: '^AlignedLeft^Aligned Left^AlignedLeft^',
            AlignedRight: '^AlignedRight^Aligned Right^AlignedRight^'
        }
    },
    InitialListMode: {
        Label: '^InitialListMode^Initial List Mode^InitialListMode^', // NEW
        List: {
            SeeAll: '^SeeAll^See All^SeeAll^',
            Summary: '^Summary^Summary^Summary^'
        }
