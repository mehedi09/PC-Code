...
CREATE TABLE [Invoices] (
    ...
    [invoice_status_code] NVARCHAR(10) NOT NULL,
    [invoice_date] DATETIME,
    [invoice_details] NVARCHAR(255),
...
CREATE TABLE [Orders] (
    ...
    [order_status_code] NVARCHAR(10) NOT NULL,
...
CREATE TABLE [Ref_Order_Status_Codes] (
    [order_status_code] NVARCHAR(10) NOT NULL,
    [order_status_description] NVARCHAR(80),
...
CREATE TABLE [Ref_Order_Item_Status_Codes] (
    [order_item_status_code] NVARCHAR(10) NOT NULL,
    [order_item_status_description] NVARCHAR(80),
    CONSTRAINT [PK_Ref_Order_Item_Status_Codes] PRIMARY KEY ([order_item_status_code])
)
GO

/*    [- eg Delivered, Out of Stock] NVARCHAR(10), */
...
CREATE TABLE [Shipments] (
    ...
    [shipment_tracking_number] NVARCHAR(80),
    [shipment_date] DATETIME,
    [other_shipment_details] NVARCHAR(255),
...
CREATE TABLE [Order_Items] (
    ...
    [order_id] INTEGER NOT NULL,
    [order_item_status_code] NVARCHAR(10) NOT NULL,
    [order_item_quantity] NVARCHAR(50),
    [order_item_price] MONEY,
    [other_order_item_details] NVARCHAR(255),
...
CREATE TABLE [Products] (
    ...
    [product_type_code] NVARCHAR(15) NOT NULL,
    [product_name] NVARCHAR(80),
    [product_price] MONEY,
    [product_color] NVARCHAR(20),
    [product_size] NVARCHAR(20),
    [product_description] NVARCHAR(255),
    [other_product_details] NVARCHAR(255),
...
CREATE TABLE [Customers] (
    ...
    [organisation_or_person] NVARCHAR(20),
    [organisation_name] NVARCHAR(40),
    [gender] NVARCHAR(1),
...
CREATE TABLE [Ref_Gender_Codes] (
    [gender_code] NVARCHAR(1) NOT NULL,
    [gender_description] NVARCHAR(80),
...
CREATE TABLE [Ref_Payment_Methods] (
    ...
    [payment_method_description] NVARCHAR(80),
...
CREATE TABLE [Customer_Payment_Methods] (
    ...
    [customer_id] INTEGER NOT NULL,
    [payment_method_code] NVARCHAR(10) NOT NULL,
    [credit_card_number] NVARCHAR(40),
    [payment_method_details] NVARCHAR(50) NULL,
...
CREATE TABLE [Ref_Product_Types] (
    [product_type_code] NVARCHAR(15) NOT NULL,
    [parent_product_type_code] NVARCHAR(15),
    [product_type_description] NVARCHAR(80),
    CONSTRAINT [PK_Ref_Product_Types] PRIMARY KEY ([product_type_code])
)
GO

/*   [eg Book, CD] NVARCHAR(1), */
